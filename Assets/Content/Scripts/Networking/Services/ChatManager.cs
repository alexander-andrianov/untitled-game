...
//
//         localLoginSession = VivoxService.Instance.GetLoginSession(account);
//
...
//         }
//
//         Debug.Log("AUDIO: " + settings.ConnectAudio + "; TEXT: " + settings.ConnectText + "; SWITCH: " +
//                   settings.SwitchToThisChannel);
//
//         localChannelSession.BeginConnect(settings.ConnectAudio, settings.ConnectText, settings.SwitchToThisChannel,
//             localChannelSession.GetConnectToken(),
//             ar =>
//             {
//                 try
//                 {
